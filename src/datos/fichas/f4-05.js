      ...
      contenido: [
        {
          ...
          items: [
            ...
            "**Dos advertencias finales sobre el uso.** La primera es el R²: mide ajuste, no verdad ni causalidad, y **subir siempre que se añade una variable, sea cual sea**, por lo que el R² ajustado penaliza esa inflación. Un R² bajo no invalida un coeficiente bien identificado, y uno alto no salva a un modelo mal especificado. La segunda es que la linealidad se refiere a **los parámetros**, no a las variables: se pueden incluir logaritmos, cuadrados e interacciones sin salir de MCO, y de hecho la especificación en logaritmos —donde los coeficientes se leen directamente como **elasticidades**— es la más habitual en economía por las razones de escala multiplicativa vistas en la ficha 4.02.",
          ],
        },
      ],
    },
      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Criterio de MCO", sub: "Un problema de optimización como el de la ficha 4.01.", cols: ["mín Σ(yᵢ − β₀ − β₁xᵢ)²"] },
            { nom: "Pendiente estimada", sub: "Covarianza dividida por varianza de x.", cols: ["β̂₁ = Sxy ÷ Sxx"] },
            { nom: "Constante", sub: "La recta pasa siempre por el punto de medias.", cols: ["β̂₀ = ȳ − β̂₁·x̄"] },
            { nom: "Descomposición de la varianza", sub: "Total = explicada + residual.", cols: ["SCT = SCE + SCR"] },
            { nom: "Bondad de ajuste", sub: "Coseno al cuadrado del ángulo de proyección.", cols: ["R² = SCE ÷ SCT"] },
            { nom: "Varianza del error", sub: "n − k − 1 grados de libertad.", cols: ["σ̂² = SCR ÷ (n − k − 1)"] },
            { nom: "Error estándar de la pendiente", sub: "Baja con la varianza de x y con n.", cols: ["EE(β̂₁) = √(σ̂² ÷ Sxx)"] },
            { nom: "Frisch-Waugh-Lovell", sub: "Controlar = regresar sobre lo no explicado.", cols: ["β̂₁ = regresión de ỹ sobre x̃ residualizados"] },
            { nom: "Sesgo de variable omitida", sub: "Necesita relevancia y correlación a la vez.", cols: ["sesgo = β_omitida · δ, con δ de regresar la omitida sobre x"] },
            { nom: "Forma matricial", sub: "La proyección ortogonal, en una línea.", cols: ["β̂ = (X′X)⁻¹X′y"] },
            { nom: "Especificación log-log", sub: "El coeficiente se lee como elasticidad.", cols: ["ln y = β₀ + β₁·ln x ⟹ β₁ = elasticidad"] },
          ],
        },
      ],
    },
      ...
      contenido: [
        {
          ...
          items: [
            ...
            "Las sumas de productos cruzados son **Sxx = 90** y **Sxy = 180**, de modo que la pendiente es 180 ÷ 90 = **2,00** y la constante 30 − 2·13 = **4,00**. Cada año adicional de estudios se asocia con **2.000 € más de salario**.",
          ],
        },
        {
          tipo: "grafico",
        ...
        },
        {
          ...
          filas: [
            ["Pendiente β̂₁", "2,00", "Sxy ÷ Sxx = 180 ÷ 90"],
            ["Constante β̂₀", "4,00", "ȳ − β̂₁·x̄ = 30 − 26"],
            ["Suma de cuadrados total", "450", "Σ(yᵢ − ȳ)²"],
            ["Suma explicada / residual", "360 / 90", "SCE + SCR = SCT"],
            ["R²", "0,80", "360 ÷ 450"],
            ["Error estándar de la regresión", "3,354", "√(90 ÷ 8)"],
            ["Error estándar de β̂₁", "0,3536", "√(11,25 ÷ 90)"],
            { celdas: ["t y p-valor", "5,657 · 0,00048", "β̂₁ ÷ EE, con 8 grados de libertad"], clase: "total" },
            ["Intervalo al 95 %", "[1,18 · 2,82]", "2,00 ± 2,306 × 0,3536"],
          ],
          nota: "Merece la pena leer el **intervalo** antes que el p-valor: los datos son compatibles con retornos de entre 1.180 y 2.820 € por año de estudio. Es un rango ancho, y lo es porque diez observaciones son pocas. El **R² de 0,80** dice que la educación explica cuatro quintas partes de la variación salarial de esta muestra, algo altísimo para datos reales, donde valores de 0,2 a 0,4 son lo normal en ecuaciones de salarios. Y nótese que la constante, 4,00, sería el salario previsto para alguien con cero años de estudio: está **fuera del rango de los datos** y no debe interpretarse.",
        },
        {
          tipo: "parrafos",
          items: [
        ...
        },
        {
          ...
          filas: [
            ...
            ["t", "—", "2,64"],
            ["R²", "0,800", "0,900"],
            { celdas: ["R² ajustado", "0,775", "0,871"], clase: "total" },
          ],
      ...
      contenido: [
        {
          ...
          items: [
            ...
            { t: "Usar el R² como criterio de calidad del modelo", d: "Mide ajuste, no verdad ni causalidad, y sube siempre que se añade cualquier variable, incluso ruido. Un R² bajo no invalida un coeficiente bien identificado y uno alto no salva un modelo mal especificado. El R² ajustado corrige la inflación mecánica, pero sigue sin decir nada sobre causalidad." },
      ...
      contenido: [
        {
          ...
          items: [
            ...
            { q: "El R² es 0,80. ¿Es un buen modelo?", a: "Dice que la recta explica el 80 % de la variación salarial de la muestra, algo excepcional en datos reales, donde las ecuaciones de salarios suelen quedarse entre 0,2 y 0,4. Pero el R² no informa sobre causalidad ni sobre especificación: sube al añadir cualquier variable, y un modelo con variables omitidas puede tener un R² excelente y coeficientes sesgados." },
