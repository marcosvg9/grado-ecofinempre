      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Rentabilidad económica (ROA)", sub: "Antes de intereses: independiente de la financiación.", cols: ["ROA = BAII / Activo total"] },
            { nom: "Rentabilidad financiera (ROE)", sub: "Después de intereses e impuestos.", cols: ["ROE = Resultado neto / Patrimonio neto"] },
            { nom: "Descomposición del ROA", sub: "Dos factores: cuánto se gana y cuánto se mueve.", cols: ["ROA = (BAII / Ventas) × (Ventas / Activo)"] },
            { nom: "DuPont de tres factores", sub: "La identidad central.", cols: ["ROE = Margen neto × Rotación × Multiplicador"] },
            { nom: "Multiplicador de apalancamiento", sub: "Cuánto activo sostiene cada euro propio.", cols: ["M = Activo total / Patrimonio neto"] },
            { nom: "Efecto apalancamiento", sub: "La expresión que explica el porqué.", cols: ["ROE = [ROA' + (ROA' − i) × D/PN] × (1 − t)"] },
          ],
