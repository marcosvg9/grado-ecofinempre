      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Articulación balance-resultados", sub: "El vínculo entre los dos documentos principales.", cols: ["PN_final = PN_inicial + Resultado + Aportaciones − Distribuciones ± Ajustes"] },
            ...
            { nom: "Flujo de explotación (indirecto)", sub: "Del devengo a la caja.", cols: ["FEE = RCAI + Ajustes sin caja ± Δ Capital corriente ± Otros flujos"] },
            { nom: "Cuadre del estado de flujos", sub: "La comprobación obligatoria.", cols: ["ΔTesorería = FE explotación + FE inversión + FE financiación"] },
          ],
        },
      ],
    },
