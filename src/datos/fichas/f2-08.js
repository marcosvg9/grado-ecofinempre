      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Equilibrio de Nash", sub: "Estabilidad frente a desviaciones unilaterales, no optimalidad.", cols: ["$s_i^*$ óptima frente a $s_{-i}^*$, para todo $i$"] },
            { nom: "Función de reacción de Cournot", sub: "Con demanda P = a − bQ y coste marginal c.", cols: ["$q_i = \\dfrac{a - c - b q_j}{2b}$"] },
            { nom: "Cournot simétrico con n empresas", sub: "Cantidad total; n = 1 da el monopolio.", cols: ["$Q = \\dfrac{n(a-c)}{b(n+1)}$"] },
            { nom: "Precio de Cournot", sub: "Tiende a c cuando n crece.", cols: ["$P = \\dfrac{a + nc}{n+1}$"] },
            { nom: "Margen y concentración", sub: "El puente entre el índice de Lerner y el HHI.", cols: ["$L$ medio $= \\dfrac{\\mathrm{HHI}}{|\\varepsilon|}$"] },
            { nom: "Bertrand con producto homogéneo", sub: "Dos empresas bastan para el resultado competitivo.", cols: ["P = CMg, beneficio nulo"] },
            { nom: "Stackelberg", sub: "Quien mueve primero se compromete y gana.", cols: ["$q_{\\text{líder}} = \\dfrac{a - c}{2b}$"] },
            { nom: "Ganancia de la colusión", sub: "Repartirse la producción de monopolio.", cols: ["$q_i = \\dfrac{Q_{\\text{monopolio}}}{n}$"] },
            { nom: "Sostenibilidad de la colusión", sub: "Con estrategia de castigo permanente.", cols: ["$\\dfrac{B_{\\text{col}}}{1-\\delta} \\geq B_{\\text{desv}} + \\dfrac{\\delta\\,B_{\\text{castigo}}}{1-\\delta}$"] },
            { nom: "Factor de descuento", sub: "Mide paciencia y también probabilidad de seguir jugando.", cols: ["$\\delta$ = (1 − p) / (1 + r)"] },
          ],
        },
      ],
    },
      ...
      contenido: [
        {
          ...
          items: [
            ...
            "**Lo que hace es cambiar los pagos del juego, no apelar a la conciencia.** Antes de la clemencia, el cártel se sostenía si $\\delta$ era suficientemente alto: el flujo de beneficios futuros compensaba la tentación de desviarse. La clemencia introduce una **segunda desviación posible**, distinta de producir de más: delatar. Y la construye de modo que sea rentable en cuanto una empresa sospeche que otra podría hacerlo primero.",
      ...
      contenido: [
        {
          ...
          items: [
            ...
            { t: "Interpretar el factor de descuento como un simple tipo de interés", d: "Incorpora también la probabilidad de que la interacción continúe. Una empresa que prevé salir del sector, vender el negocio o afrontar la entrada de un competidor disruptivo tiene un $\\delta$ bajo aunque los tipos sean cero, y ninguna promesa de castigo futuro la disuade." },
      ...
      contenido: [
        {
          ...
          items: [
            ...
            { q: "En el ejemplo, un cártel se sostiene si $\\delta \\geq 0{,}53$. ¿Qué significa exactamente ese número?", a: "Que las empresas deben valorar el futuro al menos con ese peso relativo para que el flujo de beneficios colusorios compense la ganancia inmediata de desviarse. Incorpora el tipo de interés y la probabilidad de que la interacción continúe, así que un sector con salidas frecuentes o vidas cortas no sostiene la colusión aunque los tipos sean nulos." },
          ...
          items: [
            {
              ...
              correcta: 1,
              porque: [
                "Razonan impecablemente: traicionar es la mejor respuesta a cualquier cosa que haga el otro. El problema es estructural, no de razonamiento.",
                "Cada uno hace lo mejor dado lo que hace el otro, y por eso el resultado se sostiene. Que nadie quiera moverse no significa que a nadie le convenga que ambos se muevan a la vez.",
                "El beneficio conjunto se maximiza en la casilla de cooperación, que es justamente la que no es estable.",
                "Nash es un concepto de estabilidad, no de eficiencia. Aquí el equilibrio es peor para los dos que la cooperación, y ese contraste es todo el interés del juego.",
              ],
            },
            {
              ...
              correcta: 0,
              porque: [
                "Cournot describe mercados donde lo que se fija con antelación es la capacidad —cemento, refino—; Bertrand, donde se fija precio y se puede servir toda la demanda. Elegir el modelo es elegir qué es lo rígido.",
                "Promediar dos modelos con supuestos incompatibles no da un modelo mejor, da uno sin supuestos claros.",
                "La distinción no es por sector sino por qué variable se compromete antes: hay servicios de capacidad limitada y bienes de precio flexible.",
                "Ambos son correctos dentro de sus supuestos. La pregunta útil no es cuál es verdadero sino cuál describe el compromiso que las empresas asumen realmente.",
              ],
            },
            {
              ...
              correcta: 2,
              porque: [
                "Los acuerdos de cártel son ilegales y no ejecutables ante un tribunal, que es precisamente por lo que el problema de sostenerlos es interesante.",
                "Conviene colectivamente y no conviene individualmente: esa es exactamente la definición del problema. Si bastara el interés común, no haría falta nada más.",
                "Cumplir renta 800 cada período; desviarse renta 900 una vez y 711 para siempre. La colusión solo se sostiene si el futuro pesa lo suficiente, que aquí exige $\\delta \\geq 0{,}53$.",
                "Las restricciones de capacidad ayudan, pero el mecanismo general es la repetición y el castigo, no la imposibilidad física de traicionar.",
              ],
            },
            {
              ...
              correcta: 0,
              porque: [
                "Acreditar colusión exige evidencia de comunicación o de conductas que no se explican por la competencia, como precios que no bajan cuando el coste baja.",
                "La repetición tampoco distingue: los costes comunes se mueven muchas veces al año y arrastran los precios cada vez.",
                "La pertenencia al mismo grupo elimina la cuestión —no habría dos competidores— pero no es lo que convierte el paralelismo en prueba.",
                "Si sube el crudo, sube el coste de las dos a la vez y ambas reaccionan igual. La coincidencia es lo esperable, no lo sospechoso.",
              ],
            },
          ],
