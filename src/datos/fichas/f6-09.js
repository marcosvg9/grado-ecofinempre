      ...
      contenido: [
        {
          ...
          filas: [
            ...
            { nom: "Crecimiento relativo de clientes", sub: "Compara la evolución del saldo con la de la actividad.", cols: ["g = %Δ Clientes − %Δ Ventas"] },
            { nom: "Crecimiento relativo de existencias", sub: "Mismo razonamiento sobre el almacén.", cols: ["h = %Δ Existencias − %Δ Coste de ventas"] },
            { nom: "Efecto de un cambio de vida útil", sub: "Cuánto mueve el resultado una sola estimación.", cols: ["ΔResultado = Base amortizable × (1/n₀ − 1/n₁) × (1 − t)"] },
          ],
