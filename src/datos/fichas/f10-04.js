      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Equilibrio del reparto", sub: "Gasto igual a ingreso, sin fondo acumulado.", cols: ["$\\bar P N = t \\bar S C$"] },
            { nom: "Identidad fundamental", sub: "Tres términos atados: mueve uno y mueves otro.", cols: ["$\\dfrac{\\bar P}{\\bar S} = t\\,\\dfrac{C}{N}$"] },
            { nom: "Tasa de sustitución", sub: "Pensión media sobre salario medio.", cols: ["$\\mathrm{TS} = \\dfrac{\\bar P}{\\bar S}$"] },
            { nom: "Ratio de dependencia del sistema", sub: "Cotizantes por pensión, no jóvenes por mayores.", cols: ["$\\dfrac{C}{N}$"] },
            { nom: "Tipo necesario", sub: "Si se quiere mantener TS con menos cotizantes.", cols: ["$t = \\dfrac{\\mathrm{TS}}{C/N}$"] },
