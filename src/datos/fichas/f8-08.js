      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Precio forward sin rentas", sub: "El caso más simple: solo financiación.", cols: ["$F = S(1+r)^T$"] },
            { nom: "Con rentas conocidas", sub: "Los dividendos o cupones que se dejan de cobrar.", cols: ["$F = [S - \\mathrm{VA}(\\text{rentas})](1+r)^T$"] },
            { nom: "Con coste de almacenamiento", sub: "Materias primas físicas.", cols: ["$F = [S + \\mathrm{VA}(\\text{almacenaje})](1+r)^T$"] },
            { nom: "Base", sub: "Converge a cero en el vencimiento.", cols: ["Base $= S - F$"] },
            { nom: "Resultado de una cobertura", sub: "El riesgo de precio se sustituye por riesgo de base.", cols: ["$\\text{Resultado} = S_T - F_0 \\pm \\text{Base final}$"] },
            { nom: "Ratio de cobertura óptimo", sub: "Cuando el activo cubierto no coincide con el subyacente.", cols: ["$h^* = \\rho\\,\\dfrac{\\sigma_S}{\\sigma_F}$"] },
            { nom: "Número de contratos", sub: "Redondeado al entero más próximo.", cols: ["$N = \\dfrac{h^* Q}{\\text{tamaño del contrato}}$"] },
          ],
    ...
    },
    {
      ...
      contenido: [
        ...
        },
        {
          ...
          filas: [
            ["Sin dividendos", "$50 \\times 1{,}04^{0{,}5}$", "50,99 €"],
            ["Con dividendo de 1 € a los 3 meses", "$(50 - 1/1{,}04^{0{,}25}) \\times 1{,}04^{0{,}5}$", "49,98 €"],
          ],
        ...
        },
        {
          ...
          filas: [
            ...
            ["Reducción de la varianza", "$\\rho^2 = 0{,}8^2$", "64 %"],
          ],
      ...
      contenido: [
        {
          ...
          items: [
            ...
            { q: "Se cubren 20.000 unidades con una correlación de 0,7 y volatilidades del 15 % y del 12 %. ¿Ratio y cobertura?", a: "$h = 0{,}7 \\times 0{,}15 / 0{,}12 = 0{,}875$. Equivale a cubrir 17.500 unidades. Y solo se elimina el 49 % de la varianza, porque la reducción es $\\rho^2$." },
