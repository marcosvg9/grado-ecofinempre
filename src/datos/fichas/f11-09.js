      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Convergencia relativa", sub: "La forma de medir el acercamiento.", cols: ["$\\dfrac{\\text{renta española}}{\\text{renta de Europa occidental}}$"] },
            { nom: "Diferencial de crecimiento", sub: "Lo que mueve el ratio.", cols: ["$\\text{ratio}_t = \\text{ratio}_0 \\left(\\dfrac{1+g_{\\mathrm{ESP}}}{1+g_{\\mathrm{EUR}}}\\right)^t$"] },
            { nom: "Efecto del trasvase sectorial", sub: "Sube la media sin mejorar nada dentro.", cols: ["$\\Delta\\pi = \\sum_i \\pi_i \\Delta w_i$"] },
            ...
            { nom: "Ancla institucional", sub: "Reglas externas que nadie puede relajar solo.", cols: ["adhesión $\\Rightarrow$ compromiso creíble"] },
