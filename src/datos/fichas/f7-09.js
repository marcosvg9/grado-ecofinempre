      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Valor de la empresa por descuento de flujos", sub: "Proyección explícita más valor terminal.", cols: ["EV = Σ FCFₜ/(1+WACC)ᵗ + VT/(1+WACC)ⁿ"] },
            { nom: "Valor terminal por perpetuidad", sub: "Gordon aplicado al primer flujo posterior a la proyección.", cols: ["VT = FCF_(n+1) / (WACC − g)"] },
            ...
            { nom: "Múltiplo implícito del valor terminal", sub: "La comprobación de coherencia del descuento de flujos.", cols: ["VT / EBITDA_n"] },
          ],
