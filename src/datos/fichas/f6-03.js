      ...
      contenido: [
        {
          ...
          filas: [
            ...
            { nom: "Tasa de una actividad", sub: "Segunda etapa del ABC.", cols: ["tᵢ = Coste de la actividad i / Volumen del inductor i"] },
            { nom: "Coste indirecto de un producto", sub: "Suma sobre todas las actividades que consume.", cols: ["CI_p = Σᵢ (tᵢ × consumo del inductor i por p)"] },
            { nom: "Coste unitario ABC", sub: "Directos más indirectos por actividades.", cols: ["c_p = (MP + MOD + CI_p) / Unidades de p"] },
            { nom: "Subvención cruzada", sub: "La cifra que revela el diagnóstico.", cols: ["S_p = Coste tradicional_p − Coste ABC_p"] },
          ],
