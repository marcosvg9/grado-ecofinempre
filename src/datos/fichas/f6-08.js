      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Flujo de explotación (indirecto)", sub: "Del devengo a la caja en dos bloques.", cols: ["FEE = RAI + Ajustes sin caja − $\\Delta$ NOF + Otros flujos"] },
            ...
            { nom: "Cuadre obligatorio", sub: "La comprobación que valida todo el estado.", cols: ["$\\Delta$ Tesorería = FEE + FE inversión + FE financiación"] },
          ],
        },
      ],
    },
