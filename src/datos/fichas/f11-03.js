      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Restricción presupuestaria del Estado", sub: "Las tres vías, y la tercera es la última.", cols: ["G − T = ΔDeuda + ΔBase monetaria"] },
            { nom: "Señoreaje", sub: "Recursos reales obtenidos al emitir.", cols: ["S = ΔM ÷ P"] },
            { nom: "Impuesto inflacionario", sub: "Base = saldos reales; tipo = inflación.", cols: ["II = π · (M ÷ P)"] },
            { nom: "La trampa", sub: "Subir el tipo destruye la base imponible.", cols: ["↑π ⟹ ↓(M/P) ⟹ recaudación puede caer"] },
            { nom: "Definición de Cagan", sub: "El umbral convencional de hiperinflación.", cols: ["π > 50 % mensual"] },
            { nom: "Tiempo de duplicación", sub: "La traducción legible de cualquier tasa.", cols: ["t = ln2 ÷ ln(1 + π)"] },
            { nom: "Papel de la velocidad", sub: "Lo que convierte inflación alta en hiper.", cols: ["M·V = P·Y, con V creciendo con π"] },
