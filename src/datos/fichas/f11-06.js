      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Choque de oferta", sub: "Empeora producto y precios a la vez.", cols: ["↓OA $\\Rightarrow$ ↑$P$ y ↓$Y$ simultáneamente"] },
            { nom: "Phillips con expectativas", sub: "El menú de opciones no existe.", cols: ["$\\pi = \\pi^e - a(u - u_n)$"] },
            { nom: "Tasa natural", sub: "A largo plazo el paro no depende de la inflación.", cols: ["$\\pi = \\pi^e \\Rightarrow u = u_n$"] },
            { nom: "Expectativas adaptativas", sub: "De ahí la espiral acelerativa.", cols: ["$\\pi^e_t = \\pi_{t-1}$"] },
            { nom: "Indiciación", sub: "Convierte un choque puntual en persistente.", cols: ["salarios ligados a la inflación pasada"] },
            { nom: "Ratio de sacrificio", sub: "El precio de desinflar sin credibilidad.", cols: ["$\\dfrac{\\text{puntos de producto perdidos}}{\\text{puntos de inflación reducidos}}$"] },
            { nom: "Inconsistencia temporal", sub: "Por qué el banco central se hace independiente.", cols: ["lo óptimo hoy deja de serlo mañana"] },
            { nom: "Regla de Taylor", sub: "Con inflación al 13,5 % pedía tipos superiores al 20 %.", cols: ["$i = r^* + \\pi + 0{,}5(\\pi - \\pi^*) + 0{,}5\\,\\text{brecha}$"] },
          ],
        },
      ],
    },
