      ...
      contenido: [
        {
          ...
          filas: [
            ...
            { nom: "Aritmética de la gestión activa", sub: "Resultado de Sharpe: es una identidad, no una teoría.", cols: ["R̄ activo bruto = R̄ mercado ⟹ R̄ activo neto < R̄ mercado"] },
            { nom: "Efecto de los costes a largo plazo", sub: "Lo que decide el resultado de un ahorrador.", cols: ["VF = C × (1 + r − c)ⁿ"] },
          ],
