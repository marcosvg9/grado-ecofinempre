      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Precio de un bono", sub: "Valor actual de cupones y nominal.", cols: ["$P = \\sum_t \\dfrac{C}{(1+y)^t} + \\dfrac{N}{(1+y)^n}$"] },
            { nom: "Duración de Macaulay", sub: "Media de plazos ponderada por valor actual.", cols: ["$D = \\dfrac{\\sum_t t \\cdot \\mathrm{VA}(FC_t)}{P}$"] },
            { nom: "Duración modificada", sub: "La sensibilidad porcentual del precio.", cols: ["$D^* = \\dfrac{D}{1+y}$"] },
            { nom: "Variación aproximada del precio", sub: "Aproximación de primer orden.", cols: ["$\\dfrac{\\Delta P}{P} \\approx -D^* \\Delta y$"] },
            { nom: "Convexidad", sub: "La curvatura, siempre positiva en bonos ordinarios.", cols: ["$C = \\dfrac{\\sum_t t(t+1)\\,\\mathrm{VA}(FC_t)}{P(1+y)^2}$"] },
            { nom: "Variación con corrección de convexidad", sub: "Aproximación de segundo orden.", cols: ["$\\dfrac{\\Delta P}{P} \\approx -D^* \\Delta y + \\tfrac12 C (\\Delta y)^2$"] },
            { nom: "Duración de una cartera", sub: "Media ponderada por valor de mercado.", cols: ["$D^*_{\\text{cartera}} = \\sum_i w_i D^*_i$"] },
          ],
      ...
      contenido: [
        ...
        },
        {
          ...
          filas: [
            ...
            { celdas: ["Convexidad", "$25.812{,}7 / (956{,}70 \\times 1{,}05^2)$", "24,47"], clase: "total" },
          ],
        },
        {
          tipo: "parrafos",
