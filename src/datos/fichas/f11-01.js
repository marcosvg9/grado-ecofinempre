      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Régimen maltusiano", sub: "La técnica se traduce en población, no en renta.", cols: ["↑ producción ⟹ ↑ población ⟹ renta per cápita constante"] },
            { nom: "Restricción orgánica", sub: "La energía disponible depende de la superficie.", cols: ["producción ≤ f(tierra · flujo solar anual)"] },
            { nom: "Salario real maltusiano", sub: "Por eso las epidemias lo subían.", cols: ["w ∝ tierra ÷ población"] },
            { nom: "Crecimiento compuesto", sub: "La aritmética que separa los dos mundos.", cols: ["años para duplicar ≈ ln2 ÷ ln(1+g)"] },
