      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Pago de una opción de compra", sub: "Al vencimiento, nunca negativo.", cols: ["máx(S_T − K, 0)"] },
            { nom: "Pago de una opción de venta", sub: "Simétrico.", cols: ["máx(K − S_T, 0)"] },
            { nom: "Paridad put-call", sub: "Relación de arbitraje entre ambas y el subyacente.", cols: ["C − P = S − K × e^(−rT)"] },
            { nom: "Fórmula de Black-Scholes", sub: "Para una opción de compra europea sin dividendos.", cols: ["C = S × N(d₁) − K × e^(−rT) × N(d₂)"] },
            { nom: "Parámetros d₁ y d₂", sub: "No aparece la rentabilidad esperada del subyacente.", cols: ["d₁ = [ln(S/K) + (r + σ²/2)T] / (σ√T) · d₂ = d₁ − σ√T"] },
            { nom: "Delta", sub: "Cuántas unidades de subyacente replican la opción.", cols: ["Δ = N(d₁) para la compra"] },
            { nom: "Vega", sub: "Sensibilidad a la volatilidad, siempre positiva.", cols: ["∂C/∂σ > 0 para compras y ventas"] },
          ],
    ...
    },
    {
      ...
      contenido: [
        ...
        },
        {
          ...
          filas: [
            ["d₁", "[0 + (0,04 + 0,03125)] / 0,25", "0,285"],
            ["d₂", "0,285 − 0,25", "0,035"],
            ["N(d₁)", "función de distribución normal", "0,6122"],
            ["N(d₂)", "—", "0,5140"],
            ["Valor actual del ejercicio", "100 × e^(−0,04)", "96,08 €"],
