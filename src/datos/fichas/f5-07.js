      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Tipo de interés efectivo", sub: "La TIR del instrumento, incluidos costes de transacción.", cols: ["Valor inicial = Σ Flujos_t / (1 + TIE)^t"] },
            { nom: "Coste amortizado", sub: "El valor por el que figura en el balance en cada fecha.", cols: ["CA_t = CA_(t−1) × (1 + TIE) − Flujo cobrado_t"] },
            { nom: "Ingreso financiero del período", sub: "Se devenga sobre el saldo vivo, no sobre el nominal.", cols: ["Ingreso_t = CA_(t−1) × TIE"] },
            { nom: "Valoración inicial", sub: "Los costes de transacción solo se capitalizan fuera de la cartera de valor razonable con cambios en PyG.", cols: ["VI = Valor razonable de la contraprestación ± costes de transacción"] },
