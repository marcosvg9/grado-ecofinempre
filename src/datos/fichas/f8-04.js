      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Descuento de dividendos (Gordon)", sub: "Exige g menor que k y sostenible.", cols: ["P₀ = D₁ / (k − g)"] },
            { nom: "Crecimiento sostenible", sub: "El vínculo con la política de dividendos.", cols: ["g = ROE × (1 − p)"] },
            { nom: "PER descompuesto", sub: "Explica de qué depende el múltiplo.", cols: ["PER = p / (k − g)"] },
            { nom: "Precio sobre valor contable", sub: "La regla de creación de valor en versión bursátil.", cols: ["P/VC = (ROE − g) / (k − g)"] },
            { nom: "Rentabilidad total esperada", sub: "Dividendo más revalorización.", cols: ["k = D₁/P₀ + g"] },
            { nom: "PEG", sub: "Ajuste rudimentario del PER por crecimiento.", cols: ["PEG = PER / (g en %)"] },
          ],
