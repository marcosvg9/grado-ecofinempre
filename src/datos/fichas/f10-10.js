      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Vintage", sub: "Un dato no es un número sino una sucesión.", cols: ["yₜ^(v) = estimación de t publicada en v"] },
            { nom: "Revisión", sub: "La diferencia entre dos versiones del mismo dato.", cols: ["rₜ = yₜ^(v₂) − yₜ^(v₁)"] },
            { nom: "Revisión media", sub: "Si difiere de cero, hay sesgo sistemático.", cols: ["r̄ = (1/n)·Σ rₜ"] },
            { nom: "Revisión absoluta media", sub: "La medida de magnitud, no de dirección.", cols: ["RAM = (1/n)·Σ |rₜ|"] },
            { nom: "Conciliación con lo anual", sub: "Reparte la diferencia entre trimestres.", cols: ["Σ trimestres = dato anual"] },
            { nom: "Datos en tiempo real", sub: "Juzgar con lo que se sabía entonces.", cols: ["usar yₜ^(v) con v = momento de la decisión"] },
            { nom: "Brecha de producción", sub: "Se revisa, y en la misma dirección que el PIB.", cols: ["(Y − Y*) ÷ Y*, con Y* estimado"] },
