      ...
      contenido: [
        {
          ...
          filas: [
            ...
            { nom: "Necesidad adicional por crecimiento", sub: "Lo que consume cada euro de venta nueva.", cols: ["ΔNOF ≈ n × ΔVentas"] },
            { nom: "Coste implícito del pronto pago", sub: "Suele ser muy superior al del crédito bancario.", cols: ["i = (d / (1 − d))^(365 / días adelantados) − 1"] },
          ],
