      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Endogeneidad", sub: "El supuesto que sesga: nada lo corrige salvo el diseño.", cols: ["Cov(x, u) ≠ 0 ⟹ β̂ₘᶜᵒ sesgado"] },
            { nom: "Sesgo de MCO", sub: "Su signo se deduce del mecanismo.", cols: ["plim β̂ = β + Cov(x,u) ÷ Var(x)"] },
            { nom: "Relevancia", sub: "Contrastable: se mira la primera etapa.", cols: ["Cov(z, x) ≠ 0"] },
            { nom: "Exclusión", sub: "NO contrastable: es un argumento, no un test.", cols: ["Cov(z, u) = 0"] },
            { nom: "Estimador de variables instrumentales", sub: "Ratio de covarianzas.", cols: ["β̂ᵢᵥ = Cov(z,y) ÷ Cov(z,x)"] },
            { nom: "Estimador de Wald", sub: "Instrumento binario: dos diferencias de medias.", cols: ["β̂ = Δy ÷ Δx entre grupos del instrumento"] },
            { nom: "Mínimos cuadrados en dos etapas", sub: "Se regresa sobre la parte predicha por z.", cols: ["1ª: x sobre z · 2ª: y sobre x̂"] },
            { nom: "Amplificación del sesgo", sub: "Por eso un instrumento débil es peligroso.", cols: ["sesgo ≈ δ ÷ (primera etapa)"] },
            ...
            { nom: "Error estándar", sub: "Siempre mayor que el de MCO.", cols: ["EE(β̂ᵢᵥ) = EE(forma reducida) ÷ (primera etapa)"] },
          ],
        },
      ],
    },
    {
      ...
      contenido: [
        ...
        },
        {
          ...
          filas: [
            ["Primera etapa (Δ educación)", "12,30 − 12,00", "0,30 años"],
            ["Forma reducida (Δ salario)", "28,78 − 28,00", "0,78 mil €"],
            ["Estimador de Wald", "0,78 ÷ 0,30", "2,60"],
            ["Error estándar", "0,09 ÷ 0,30", "0,300"],
            ["Intervalo al 95 %", "2,60 ± 1,96 × 0,30", "[2,01 · 3,19]"],
            { celdas: ["F de primera etapa", "t² = 5²", "25 — instrumento fuerte"], clase: "total" },
