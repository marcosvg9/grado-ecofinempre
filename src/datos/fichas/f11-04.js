      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Multiplicador monetario", sub: "c = efectivo/depósitos · r = reservas/depósitos.", cols: ["m = (1 + c) ÷ (c + r)"] },
            { nom: "Oferta monetaria", sub: "La base no cayó; el multiplicador sí.", cols: ["M = m · Base monetaria"] },
            { nom: "Pánico bancario", sub: "Sube c y sube r a la vez: m se hunde.", cols: ["↑c y ↑r ⟹ ↓↓m"] },
            { nom: "Tipo de interés real", sub: "Con deflación, el real es altísimo aunque el nominal sea cero.", cols: ["r = i − π, con π < 0"] },
            { nom: "Deflación por deuda", sub: "Pagar todos a la vez aumenta lo que se debe.", cols: ["↓P ⟹ ↑ deuda real ⟹ ventas forzadas ⟹ ↓P"] },
            { nom: "Esposas doradas", sub: "El compromiso con el oro impide responder.", cols: ["tipo fijo + capital libre ⟹ sin política monetaria"] },
            { nom: "Regularidad de la recuperación", sub: "La evidencia más limpia del episodio.", cols: ["salir antes del oro ⟹ recuperarse antes"] },
          ],
        },
      ],
    },
