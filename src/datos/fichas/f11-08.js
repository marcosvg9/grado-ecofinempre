...
export default {
  ...
  abre: "11.09 España · 1.11 Escuelas heterodoxas · 8.10 Gestión de riesgos · 10.06 SEC 2010",
  secciones: [
    {
      titulo: "Desarrollo",
      contenido: [
      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Apalancamiento", sub: "Cuántas veces el activo supera al capital.", cols: ["$L = \\dfrac{\\text{Activo}}{\\text{Capital}}$"] },
            { nom: "Umbral de insolvencia", sub: "Una caída igual al ratio de capital lo borra.", cols: ["$\\dfrac{\\Delta\\text{Activo}}{\\text{Activo}} = -\\dfrac{\\text{Capital}}{\\text{Activo}} \\Rightarrow$ capital $= 0$"] },
            { nom: "Amplificación", sub: "Vale en los dos sentidos, y por eso atrae.", cols: ["$\\Delta\\%$ capital $= L \\cdot \\Delta\\%$ activo"] },
            { nom: "Bucle de la garantía", sub: "El motor del auge.", cols: ["↑precio $\\Rightarrow$ ↑crédito $\\Rightarrow$ ↑demanda $\\Rightarrow$ ↑precio"] },
            ...
            { nom: "Desapalancamiento colectivo", sub: "Lo sensato para uno, ruinoso para todos.", cols: ["ventas forzadas $\\Rightarrow$ ↓precios $\\Rightarrow$ ↓capital $\\Rightarrow$ más ventas"] },
