      ...
      contenido: [
        {
          ...
          items: [
            ...
            "La beta se estima en la práctica por **regresión** de las rentabilidades del activo sobre las del mercado. Esa regresión ofrece un subproducto valioso: el $R^2$ indica qué proporción de la varianza del activo es sistemática y qué proporción es específica y diversificable. Para una acción individual el $R^2$ típico ronda el 20 % o el 30 %, lo que significa que la mayor parte de su volatilidad desaparece al meterla en una cartera.",
      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Beta de un activo", sub: "Contribución al riesgo de la cartera de mercado.", cols: ["$\\beta = \\dfrac{\\mathrm{Cov}(R_i, R_m)}{\\mathrm{Var}(R_m)}$"] },
            { nom: "Relación del CAPM", sub: "La línea del mercado de títulos.", cols: ["$E(R_i) = R_f + \\beta_i [E(R_m) - R_f]$"] },
            { nom: "Descomposición de la varianza", sub: "Sistemática más específica.", cols: ["$\\sigma_i^2 = \\beta_i^2 \\sigma_m^2 + \\sigma_\\varepsilon^2$"] },
            { nom: "Proporción sistemática", sub: "Es el $R^2$ de la regresión.", cols: ["$R^2 = \\dfrac{\\beta_i^2 \\sigma_m^2}{\\sigma_i^2}$"] },
            { nom: "Beta de una cartera", sub: "Aditiva, como la duración de la ficha 8.02.", cols: ["$\\beta_p = \\sum_i w_i \\beta_i$"] },
            { nom: "Desapalancar la beta (Hamada)", sub: "Aísla el riesgo del negocio del financiero.", cols: ["$\\beta_U = \\dfrac{\\beta_L}{1 + (1-t)\\,D/E}$"] },
            { nom: "Alfa de Jensen", sub: "Rendimiento no explicado por el riesgo asumido.", cols: ["$\\alpha = \\bar R_i - [R_f + \\beta(\\bar R_m - R_f)]$"] },
          ],
        },
      ],
    },
    {
      ...
      contenido: [
        ...
        },
        {
          ...
          filas: [
            ["Beta", "$0{,}0264 / 0{,}15^2$", "1,173"],
            ["Varianza total del activo", "$0{,}25^2$", "0,0625"],
            ["Varianza sistemática", "$1{,}173^2 \\times 0{,}0225$", "0,0310"],
            ["Varianza específica", "0,0625 − 0,0310", "0,0315"],
            ["Proporción sistemática ($R^2$)", "0,0310 / 0,0625", "49,5 %"],
      ...
      contenido: [
        {
          ...
          items: [
            ...
            { q: "Una acción tiene volatilidad del 40 % y un $R^2$ del 20 %. ¿Cuánto de su riesgo se remunera?", a: "Solo el 20 % de su varianza es sistemática; el 80 % restante desaparece al diversificar. Su volatilidad individual, muy alta, dice poco sobre la rentabilidad que exigirá el mercado." },
