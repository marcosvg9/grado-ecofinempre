      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Punto muerto en unidades", sub: "Cuántas unidades cubren los costes fijos.", cols: ["Q* = CF / (p − cv)"] },
            { nom: "Punto muerto en euros", sub: "Útil cuando hay varios productos.", cols: ["V* = CF / ratio de margen de contribución"] },
            { nom: "Ratio de margen de contribución", sub: "Qué proporción de cada euro vendido queda tras el coste variable.", cols: ["rmc = (p − cv) / p"] },
            { nom: "Margen de seguridad", sub: "Cuánto pueden caer las ventas antes de entrar en pérdidas.", cols: ["MS = (Ventas − V*) / Ventas"] },
            { nom: "Grado de apalancamiento operativo", sub: "Dos expresiones equivalentes.", cols: ["GAO = MC / BAII = %ΔBAII / %ΔVentas"] },
            { nom: "Volumen para un beneficio objetivo", sub: "El punto muerto es el caso particular con B = 0.", cols: ["Q = (CF + B objetivo) / (p − cv)"] },
          ],
