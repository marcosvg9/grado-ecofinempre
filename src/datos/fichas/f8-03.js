      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Tipo al contado (cupón cero)", sub: "El aplicable a un único pago en el plazo n.", cols: ["P = N / (1 + sₙ)ⁿ"] },
            { nom: "Forward implícito de un período", sub: "Condición de no arbitraje entre plazos.", cols: ["(1 + s₂)² = (1 + s₁) × (1 + f₁,₂)"] },
            { nom: "Forward general", sub: "Entre los plazos m y n.", cols: ["f_m,n = [(1+sₙ)ⁿ / (1+s_m)^m]^(1/(n−m)) − 1"] },
            { nom: "Teoría de expectativas puras", sub: "Sin prima: el largo es media de los cortos esperados.", cols: ["(1 + sₙ)ⁿ = Π (1 + E[rₜ])"] },
            { nom: "Con prima de plazo", sub: "La prima explica la pendiente positiva habitual.", cols: ["sₙ = media de cortos esperados + primaₙ"] },
            { nom: "Pendiente de la curva", sub: "El indicador que se sigue como señal de ciclo.", cols: ["Pendiente = s₁₀ años − s₂ años"] },
          ],
          nota: "El **bootstrapping** consiste en aplicar la primera fórmula de forma recursiva: conocido s₁, se despeja s₂ del precio de un bono a dos años con cupón, y así sucesivamente. Sin ese paso, comparar TIR de bonos con cupones distintos mezcla plazos.",
        },
      ],
    },
    {
      ...
      contenido: [
        ...
        },
        {
          ...
          filas: [
            ...
            ["Año 2", "3,50 %", "4,00 %", "1,035² / 1,03 − 1"],
            ["Año 3", "3,80 %", "4,40 %", "1,038³ / 1,035² − 1"],
          ],
      ...
      contenido: [
        {
          tipo: "preguntas",
          items: [
            { q: "El tipo a un año es 2 % y a dos años 3 %. ¿Cuál es el forward implícito del segundo año?", a: "1,03² / 1,02 − 1 = 4,01 %. El tipo al contado sube un punto y el forward sube dos: el largo es un promedio que suaviza el perfil de los tipos esperados." },
