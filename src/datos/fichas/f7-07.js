      ...
      contenido: [
        {
          ...
          filas: [
            ...
            { nom: "Crecimiento sostenible", sub: "Cuánto puede crecer sin ampliar capital ni endeudarse más.", cols: ["$g = \\mathrm{ROE}\\,(1-p)$"] },
            { nom: "Precio tras el dividendo", sub: "La caída teórica en la fecha de descuento.", cols: ["$P_{\\text{ex}} \\approx P_{\\text{cum}} - D$"] },
            { nom: "Efecto de una recompra", sub: "El precio no cae: se reduce el número de acciones.", cols: ["$N' = N - \\dfrac{\\text{Importe}}{P}$"] },
          ],
