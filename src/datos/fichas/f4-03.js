      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Estimador", sub: "Función de la muestra: es una variable aleatoria.", cols: ["θ̂ = g(X₁, …, Xₙ)"] },
            { nom: "Insesgadez", sub: "No se equivoca sistemáticamente.", cols: ["E[θ̂] = θ"] },
            { nom: "Consistencia", sub: "Converge al parámetro al crecer la muestra.", cols: ["θ̂ →ᵖ θ cuando n → ∞"] },
            { nom: "Eficiencia", sub: "Mínima varianza entre los insesgados.", cols: ["Var(θ̂) mínima"] },
            { nom: "Error cuadrático medio", sub: "Permite cambiar algo de sesgo por menos varianza.", cols: ["ECM = Var(θ̂) + sesgo²"] },
            { nom: "Error estándar de la media", sub: "La ley de la raíz: el origen de todo el coste.", cols: ["EE(x̄) = σ ÷ √n"] },
            { nom: "Teorema central del límite", sub: "Vale sea cual sea la distribución de partida.", cols: ["x̄ ≈ N(μ, σ²/n) para n grande"] },
            { nom: "Error estándar de una proporción", sub: "Máximo en p = 0,5; el caso más desfavorable.", cols: ["EE(p̂) = √(p(1−p)/n)"] },
            { nom: "Intervalo de confianza (media)", sub: "t si σ se estima; z si n es grande.", cols: ["x̄ ± t₍ₙ₋₁₎ · s ÷ √n"] },
            { nom: "Tamaño muestral necesario", sub: "Crece con el cuadrado de la precisión exigida.", cols: ["n = (z·σ ÷ margen)²"] },
            { nom: "Lectura correcta del IC", sub: "La aleatoriedad está en el intervalo, no en θ.", cols: ["95 % de los intervalos contienen θ"] },
          ],
        },
      ],
    },
    {
      ...
      contenido: [
        ...
        },
        {
          ...
          nota: "Las tres curvas describen la misma población y dicen cosas muy distintas. La de **individuos** es asimétrica, tiene moda baja y una cola larguísima: preguntarle a una sola persona informa muy poco. La media de **25** ya es casi simétrica y está centrada en 30. La media de **100** es prácticamente normal y **mucho más estrecha**. Eso es el teorema central del límite: la forma de la población deja de importar, y lo único que gobierna la precisión es √n. Obsérvese que pasar de 25 a 100 —cuadruplicar el trabajo de campo— **estrecha la curva exactamente a la mitad**, ni un ápice más.",
        },
        {
          tipo: "tabla",
          cabecera: ["Tamaño de muestra", "Error estándar", "Margen al 95 %", "Intervalo para la media"],
          filas: [
            ["25", "4,61", "± 9,04", "[20,96 · 39,04]"],
            ["100", "2,31", "± 4,52", "[25,48 · 34,52]"],
            ["400", "1,15", "± 2,26", "[27,74 · 32,26]"],
            { celdas: ["1.600", "0,58", "± 1,13", "[28,87 · 31,13]"], clase: "total" },
          ],
        ...
        },
        {
          tipo: "parrafos",
          items: [
            "**Segundo, el caso de una proporción, que es el de la tasa de paro.** Supongamos una muestra de activos en la que el 12 % declara estar en paro. El error estándar de una proporción es √(p(1−p)/n), y el margen depende brutalmente del tamaño:",
          ],
        },
        {
          tipo: "tabla",
          ...
          filas: [
            ["1.000", "0,0103", "± 2,01 pp", "[9,99 % · 14,01 %]"],
            ["10.000", "0,0033", "± 0,64 pp", "[11,36 % · 12,64 %]"],
            { celdas: ["65.000 — escala EPA", "0,0013", "± 0,25 pp", "[11,75 % · 12,25 %]"], clase: "total" },
            ["160.000", "0,0008", "± 0,16 pp", "[11,84 % · 12,16 %]"],
          ],
      ...
      contenido: [
        {
          ...
          items: [
            ...
            "**El caso más frecuente es el comentario de décimas.** Cuando una tasa de paro pasa del 12,3 % al 12,2 %, la reacción estándar es interpretar el signo. Con un margen de ±0,25 puntos, esa variación está muy dentro del ruido muestral, y afirmar que el paro ha bajado es una afirmación que los datos no sostienen. Lo correcto es decir que **no se aprecia un cambio significativo**, lo cual es información y no un rodeo. La tentación de comentar la décima viene de que el número se publica con un decimal, y **la precisión de la impresión no es la precisión de la medida**.",
      ...
      contenido: [
        {
          ...
          items: [
            ...
            { t: "Usar la normal cuando la muestra es pequeña y σ se ha estimado", d: "Hay que usar la t de Student, cuyas colas más gruesas reconocen la incertidumbre sobre la varianza. Con 9 grados de libertad el valor crítico es 2,262 frente a 1,960, y el intervalo es un 15 % más ancho. A partir de unos 100 grados de libertad la diferencia deja de importar." },
      ...
      contenido: [
        {
          ...
          items: [
            ...
            { q: "Una encuesta de 1.000 personas da un margen de ±2 puntos. ¿Cuántas hacen falta para bajarlo a ±1?", a: "Cuatro mil, porque el error decrece con la raíz de n: para dividir el margen entre dos hay que multiplicar la muestra por cuatro. Bajarlo a ±0,2 puntos exigiría 100.000 entrevistas. Esa aritmética es la que fija el tamaño y el coste de cualquier encuesta oficial." },
            { q: "La tasa de paro pasa del 12,3 % al 12,2 %. ¿Ha bajado el paro?", a: "No se puede afirmar. Con una muestra de escala EPA el margen es de unas ±0,25 puntos, así que una décima está muy dentro del ruido muestral. La conclusión correcta es que no se aprecia un cambio significativo, y eso antes de contar los errores no muestrales, que no entran en la fórmula y suelen ser mayores." },
