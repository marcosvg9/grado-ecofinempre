      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Volumen a base fija", sub: "Aditivo y con sesgo creciente.", cols: ["Vₜ = Σ qᵢₜ · pᵢ₀"] },
            { nom: "Tasa a precios del año anterior", sub: "El eslabón del encadenamiento.", cols: ["τₜ = Σ qᵢₜ·pᵢ,ₜ₋₁ ÷ Σ qᵢ,ₜ₋₁·pᵢ,ₜ₋₁"] },
            { nom: "Índice encadenado", sub: "Ponderaciones nunca mayores de un año.", cols: ["Iₜ = Iₜ₋₁ · τₜ"] },
            { nom: "Sesgo de sustitución", sub: "Por qué la base fija sobrestima.", cols: ["las cantidades crecen donde los precios caen"] },
            { nom: "No aditividad", sub: "Consecuencia matemática, no error.", cols: ["Σ componentes encadenados ≠ agregado encadenado"] },
            { nom: "Contribución al crecimiento", sub: "La única forma correcta de calcularla.", cols: ["cᵢₜ = wᵢ,ₜ₋₁ · tasa de volumen de i"] },
            { nom: "Deflactor implícito", sub: "Tipo Paasche: la cesta cambia cada periodo.", cols: ["D = PIB nominal ÷ PIB en volumen"] },
