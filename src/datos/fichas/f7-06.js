          ...
          items: [
            {
              ...
              correcta: 1,
              porque: [
                "Leerlo así invierte su utilidad: se convierte en una conclusión falsa cuando en realidad es un punto de partida.",
                "Su valor está en el contrapositivo: si la financiación sí afecta al valor, tiene que ser por alguna de esas fricciones, y ahí es donde hay que mirar.",
                "El escudo fiscal aparece en la versión con impuestos, que es una extensión posterior, no el teorema original.",
                "El teorema original dice lo contrario: sin fricciones no hay óptimo porque todas las estructuras valen igual.",
              ],
            },
            {
              ...
              correcta: 1,
              porque: [
                "El razonamiento olvida que las ponderaciones no son lo único que cambia: también cambian los costes que se ponderan.",
                "Es el resultado central de Modigliani-Miller: la palanca redistribuye el riesgo entre acreedores y accionistas, pero no lo hace desaparecer.",
                "Los covenants son una restricción práctica, no la razón por la que el argumento falla.",
                "El coste de la deuda también sube, pero el mecanismo que cancela el efecto es el encarecimiento de los fondos propios, mucho más rápido.",
              ],
            },
            {
              ...
              correcta: 1,
              porque: [
                "Son deducibles, pero una deducción sin base contra la que aplicarse no produce ahorro alguno.",
                "Una empresa en pérdidas no obtiene ahorro fiscal, justo cuando más endeudada suele estar. El escudo desaparece precisamente en el peor momento.",
                "El acreedor no determina la deducibilidad; el límite es cuantitativo y depende del resultado operativo.",
                "No hay tal proporción fija: el límite se define sobre el beneficio operativo, no como un porcentaje del gasto financiero.",
              ],
            },
            {
              ...
              correcta: 1,
              porque: [
                "No hay diversificación posible: ambos apalancamientos actúan sobre la misma variable, las ventas.",
                "Primero los costes fijos amplifican la caída de ventas hasta el resultado operativo, y después los intereses amplifican esa caída hasta el resultado del accionista.",
                "Interactúan de la peor manera posible, multiplicándose: es la combinación que más empresas se lleva por delante en cada recesión.",
                "El efecto disciplinante de la deuda existe en la teoría de incentivos, pero no compensa la amplificación mecánica del riesgo.",
              ],
            },
          ],
