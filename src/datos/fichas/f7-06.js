      ...
      contenido: [
        {
          ...
          filas: [
            ...
            { nom: "MM II sin impuestos", sub: "El coste de los fondos propios crece linealmente con la deuda.", cols: ["Ke = Ku + (Ku − Kd) × D/E"] },
            { nom: "MM I con impuestos", sub: "El escudo fiscal añade valor.", cols: ["V_L = V_U + t × D"] },
            { nom: "MM II con impuestos", sub: "La pendiente se suaviza por el factor fiscal.", cols: ["Ke = Ku + (Ku − Kd) × (1 − t) × D/E"] },
            { nom: "Valor de la empresa sin deuda", sub: "Flujo operativo neto descontado al coste del activo.", cols: ["V_U = BAII × (1 − t) / Ku"] },
            { nom: "Teoría del equilibrio", sub: "El óptimo iguala beneficio marginal y coste marginal.", cols: ["V_L = V_U + VA(escudo fiscal) − VA(costes de insolvencia)"] },
          ],
    ...
    },
    {
      ...
      contenido: [
        ...
        },
        {
          ...
          nota: "Comprobación del caso intermedio: 75.000 / 0,0909 = **825.000 €**, que coincide con V_U + t × D. El WACC baja y el valor sube, pero fíjate en que **el coste de los fondos propios sube más de dos puntos**: el accionista no está ganando gratis, está aceptando más riesgo a cambio.",
        },
        {
          tipo: "parrafos",
          items: [
