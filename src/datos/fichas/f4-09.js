...
export default {
  ...
  tiempo: "5 h",
  nucleo:
    "Regresar dos series con raíz unitaria produce relaciones espurias con R² excelentes y estadísticos t enormes, aunque las series sean absolutamente independientes. Comprobar la estacionariedad no es un trámite previo: es lo que separa un resultado de una ilusión.",
      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Estacionariedad débil", sub: "Media y varianza constantes; la clave del análisis.", cols: ["E[yₜ] = μ · Var(yₜ) = σ² · Cov(yₜ, yₜ₋ₖ) = γₖ"] },
            { nom: "Proceso AR(1)", sub: "Estacionario si |φ| < 1.", cols: ["yₜ = c + φ·yₜ₋₁ + εₜ"] },
            { nom: "Persistencia de un choque", sub: "Con φ = 0,9 la mitad sigue ahí siete periodos después.", cols: ["vida media = ln(0,5) ÷ ln(φ)"] },
            { nom: "Paseo aleatorio", sub: "El choque es permanente; la varianza crece con t.", cols: ["yₜ = yₜ₋₁ + εₜ  (φ = 1)"] },
            { nom: "Orden de integración", sub: "Cuántas diferencias hacen falta.", cols: ["yₜ ~ I(d)"] },
            { nom: "Dickey-Fuller aumentado", sub: "Los valores críticos NO son los de la t.", cols: ["Δyₜ = α + γ·yₜ₋₁ + Σδᵢ·Δyₜ₋ᵢ + εₜ · H₀: γ = 0"] },
            { nom: "Valores críticos con constante", sub: "Frente a −1,96 de la normal.", cols: ["1 %: −3,43 · 5 %: −2,86 · 10 %: −2,57"] },
            { nom: "Cointegración", sub: "Las series están atadas a largo plazo.", cols: ["y, x ~ I(1) y (y − βx) ~ I(0)"] },
            { nom: "Corrección del error", sub: "λ < 0 mide la velocidad de ajuste.", cols: ["Δyₜ = α + λ·(yₜ₋₁ − βxₜ₋₁) + γ·Δxₜ + εₜ"] },
      ...
      contenido: [
        ...
        },
        {
          ...
          filas: [
            ...
            ["R²", "0,864", "«Explica el 86 % de la variación»"],
        ...
        },
        {
          ...
          items: [
            ...
            "**Y una nota sobre persistencia, que ayuda a leer cualquier serie macroeconómica.** En un proceso autorregresivo, la vida media de un choque es ln(0,5) dividido por el logaritmo del coeficiente. Con φ = 0,5, la mitad del efecto desaparece en **un solo periodo**. Con φ = 0,9, hacen falta **6,6 periodos**. Con φ = 0,99, **69 periodos**, y a efectos prácticos la serie es indistinguible de un paseo aleatorio en cualquier muestra realista. Ahí está el motivo de que los contrastes de raíz unitaria tengan tan poca potencia: **la diferencia entre 0,99 y 1,00 es enorme conceptualmente y casi invisible en doscientos datos**.",
          ],
        },
      ],
    },
      ...
      contenido: [
        {
          tipo: "acordeon",
          items: [
            { t: "Regresar niveles de series con tendencia sin comprobar estacionariedad", d: "Es la fuente de resultados espurios más común en macroeconomía. En el ejemplo, dos paseos aleatorios independientes dan R² de 0,86 y t de 19, y la simulación produce falsos positivos el 79,5 % de las veces en lugar del 5 %. La comprobación previa no es un trámite: es lo que distingue un resultado de una ilusión." },
