      ...
      contenido: [
        {
          ...
          filas: [
            ...
            { nom: "Coherencia", sub: "La definición operativa.", cols: ["y es coherente si y solo si y = S·b para algún b"] },
            ...
            { nom: "Forma general", sub: "Todos los métodos son este.", cols: ["ỹ = S · P · ŷ, y solo cambia P"] },
            { nom: "Condición de invariancia", sub: "No tocar lo que ya cuadra.", cols: ["P·S = I: preserva la insesgadez"] },
