      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "VaR paramétrico", sub: "Supone normalidad. z al 99 % es 2,326.", cols: ["$\\mathrm{VaR} = z_\\alpha\\,\\sigma\\,V$"] },
            { nom: "Escalado temporal", sub: "Válido solo si las rentabilidades son independientes.", cols: ["$\\mathrm{VaR}_T = \\mathrm{VaR}_{1\\text{ día}} \\sqrt T$"] },
            { nom: "Déficit esperado", sub: "Media de las pérdidas que superan el VaR.", cols: ["$\\mathrm{ES} = E[L \\mid L > \\mathrm{VaR}]$"] },
            { nom: "Déficit esperado bajo normalidad", sub: "$\\varphi$ es la densidad normal.", cols: ["$\\mathrm{ES} = \\sigma\\,\\dfrac{\\varphi(z_\\alpha)}{1-\\alpha}\\,V$"] },
            { nom: "Pérdida esperada por crédito", sub: "La descomposición estándar del riesgo de crédito.", cols: ["$\\mathrm{PE} = \\mathrm{PD} \\times \\mathrm{LGD} \\times \\mathrm{EAD}$"] },
            { nom: "Ratio de capital", sub: "Requisito mínimo más colchones.", cols: ["CET1 = Capital ordinario / Activos ponderados por riesgo"] },
            { nom: "Contraste retrospectivo", sub: "Excepciones esperadas en $n$ días al nivel $\\alpha$.", cols: ["$\\text{Excepciones esperadas} = n(1-\\alpha)$"] },
          ],
        },
      ],
    },
      ...
      contenido: [
        ...
        },
        {
          ...
          filas: [
            ...
            ["VaR a 10 días al 99 %", "$279.100 \\times \\sqrt{10}$", "882.600 €"],
      ...
      contenido: [
        {
          ...
          items: [
            ...
            { q: "Cartera de 5 M€, volatilidad diaria del 1,5 %. ¿VaR diario al 99 %?", a: "$2{,}326 \\times 1{,}5\\ \\% \\times 5.000.000 = 174.450$ €. A diez días, multiplicando por $\\sqrt{10}$, unos 551.700 €, siempre que las rentabilidades sean independientes." },
