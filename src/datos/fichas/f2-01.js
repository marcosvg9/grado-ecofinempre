      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Función de utilidad", sub: "Representa un orden, no una magnitud cardinal.", cols: ["U(x₁, x₂) tal que A ≽ B ⟺ U(A) ≥ U(B)"] },
            { nom: "Invarianza ordinal", sub: "f monótona creciente.", cols: ["U y f∘U representan las mismas preferencias"] },
            { nom: "Utilidad marginal", sub: "No es invariante: depende de la representación.", cols: ["UMgᵢ = ∂U / ∂xᵢ"] },
            { nom: "Relación marginal de sustitución", sub: "Sí es invariante. Es la pendiente de la indiferencia.", cols: ["RMS = −dx₂/dx₁ = UMg₁ / UMg₂"] },
            { nom: "Restricción presupuestaria", sub: "Pendiente igual al precio relativo.", cols: ["p₁x₁ + p₂x₂ = m"] },
            { nom: "Homogeneidad de grado cero", sub: "Ausencia de ilusión monetaria.", cols: ["x(λp, λm) = x(p, m) ∀λ > 0"] },
          ],
          nota: "Comprobación de la invarianza de la RMS: si V = f(U), entonces ∂V/∂xᵢ = f′(U)·∂U/∂xᵢ, y al calcular el cociente el factor **f′(U) se cancela**. Es la razón formal de que la RMS tenga contenido económico y las utilidades marginales no.",
        },
      ],
    },
    {
      ...
      contenido: [
        {
          tipo: "parrafos",
          items: [
            "Sea **U(x, y) = x^0,5 · y^0,5**, con precios **pₓ = 4**, **p_y = 6** y renta **m = 120**. La condición de tangencia iguala la relación marginal de sustitución al precio relativo.",
          ],
        },
        {
          tipo: "tabla",
          ...
          filas: [
            ["Utilidades marginales", "UMgₓ = 0,5·x^−0,5·y^0,5 ; UMg_y = 0,5·x^0,5·y^−0,5", "—"],
            ["Relación marginal de sustitución", "UMgₓ / UMg_y", "y / x"],
            ["Condición de tangencia", "y / x = pₓ / p_y = 4/6", "y = (2/3)x"],
            ["Sustituir en el presupuesto", "4x + 6·(2/3)x = 120", "8x = 120"],
            { celdas: ["Cesta óptima", "—", "x = 15 ; y = 10"], clase: "total" },
            ["Utilidad alcanzada", "√(15 · 10)", "12,247"],
      ...
      contenido: [
        {
          ...
          items: [
            ...
            { q: "U = x^0,3·y^0,7, m = 500, pₓ = 5, p_y = 10. ¿Cesta óptima?", a: "En Cobb-Douglas los exponentes son las proporciones de gasto: 150 € en x y 350 € en y. Por tanto x = 30 e y = 35." },
