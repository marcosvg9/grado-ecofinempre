      ...
      contenido: [
        {
          ...
          filas: [
            ...
            { nom: "Tasa de paro", sub: "Sobre activos, no sobre población.", cols: ["$u = \\dfrac{\\text{Parados}}{\\text{Activos}}$"] },
            { nom: "Tasa de actividad", sub: "Sobre población de 16 a 64 años.", cols: ["$\\dfrac{\\text{Activos}}{\\text{Población en edad de trabajar}}$"] },
            { nom: "Tasa de empleo", sub: "Más informativa que el paro en comparaciones.", cols: ["$\\dfrac{\\text{Ocupados}}{\\text{Población en edad de trabajar}}$"] },
            ...
            { nom: "Tasa de temporalidad", sub: "El margen sobre el que recae el ajuste.", cols: ["$\\dfrac{\\text{Temporales}}{\\text{Asalariados}}$"] },
            { nom: "Ley de Okun", sub: "En España, en torno al doble que en la zona euro.", cols: ["$\\Delta u = -\\beta\\,(\\text{crecimiento del PIB} - \\text{tendencia})$"] },
            { nom: "Margen de la tasa de paro", sub: "Una décima trimestral no es distinguible de cero.", cols: ["$\\pm 0{,}25$ pp aproximadamente (ficha 4.03)"] },
          ],
        },
      ],
    },
