      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Flujo de caja libre (FCF)", sub: "Antes de intereses: el flujo del proyecto o de la empresa.", cols: ["FCF = BAII × (1 − t) + Amortización − ΔNOF − CAPEX"] },
            { nom: "Escudo fiscal de la amortización", sub: "Por eso la amortización se suma después de impuestos.", cols: ["Escudo = Amortización × t"] },
            { nom: "Flujo para el accionista (FCFE)", sub: "Se descuenta al coste de los fondos propios, no al WACC.", cols: ["FCFE = FCF − Intereses × (1 − t) + ΔDeuda"] },
            { nom: "Necesidades operativas de fondos", sub: "Se recuperan al liquidar el proyecto.", cols: ["NOF = Existencias + Clientes − Proveedores"] },
            { nom: "Valor residual por perpetuidad", sub: "Gordon aplicado al último flujo proyectado.", cols: ["VR = FCF_(n+1) / (k − g)"] },
