      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Coste de los fondos propios (CAPM)", sub: "Solo se remunera el riesgo no diversificable.", cols: ["Ke = Rf + β × (Rm − Rf)"] },
            { nom: "Coste de la deuda después de impuestos", sub: "El escudo fiscal abarata la financiación ajena.", cols: ["Kd_neto = Kd × (1 − t)"] },
            { nom: "Coste medio ponderado del capital", sub: "Ponderaciones a valor de mercado.", cols: ["WACC = E/(D+E) × Ke + D/(D+E) × Kd × (1 − t)"] },
            { nom: "Desapalancar la beta (Hamada)", sub: "Para aislar el riesgo del negocio del financiero.", cols: ["βU = βL / [1 + (1 − t) × D/E]"] },
            { nom: "Reapalancar la beta", sub: "Con la estructura financiera objetivo del proyecto.", cols: ["βL = βU × [1 + (1 − t) × D/E]"] },
            ...
            { nom: "Valor económico añadido", sub: "El valor creado en euros de un ejercicio.", cols: ["EVA = (ROIC − WACC) × Capital invertido"] },
          ],
      ...
      contenido: [
        ...
        },
        {
          ...
          filas: [
            ...
            { celdas: ["Valor económico añadido (EVA)", "(8,38 % − 7,08 %) × 680.000", "≈ 8.850 €"], clase: "total" },
          ],
