      ...
      contenido: [
        {
          ...
          filas: [
            ...
            { nom: "Identidad sectorial", sub: "Aritmética, no teoría.", cols: ["$\\sum$ B.9 sectores residentes $=$ saldo con el S.2"] },
            { nom: "Doble estimación", sub: "Su diferencia mide la calidad del sistema.", cols: ["B.9 no financiero $\\approx$ B.9F financiero"] },
          ],
        },
      ],
    },
      ...
      contenido: [
        ...
        },
        {
          ...
          filas: [
            ...
            ["$\\pm$ Transferencias de capital netas", "D.9", "+20", "+10", "−30"],
