      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Coste laboral unitario", sub: "Lo que cuesta el trabajo por unidad producida.", cols: ["CLU = (Remuneración ÷ asalariados) ÷ (VAB ÷ ocupados)"] },
            { nom: "Forma equivalente", sub: "Coste laboral total sobre producción.", cols: ["CLU = Remuneración total ÷ VAB en volumen"] },
            { nom: "Variación", sub: "Lo que erosiona no son los salarios altos.", cols: ["ΔCLU ≈ Δsalarios − Δproductividad"] },
            { nom: "Competitividad-coste relativa", sub: "Solo importa frente a los socios comerciales.", cols: ["CLU relativo = CLU propio ÷ CLU de los socios"] },
            { nom: "Tipo de cambio real", sub: "En unión monetaria, el nominal no ayuda.", cols: ["TCR = TCN · (precios propios ÷ ajenos)"] },
            ...
            { nom: "Descomposición", sub: "Distingue mejora genuina de reasignación.", cols: ["Δπ = Σ wᵢΔπᵢ (dentro) + Σ πᵢΔwᵢ (entre)"] },
