      ...
      contenido: [
        {
          ...
          filas: [
            ...
            { nom: "Residencia", sub: "Territorio, no nacionalidad.", cols: ["centro de interés económico predominante (≥ 1 año)"] },
            { nom: "Precio económicamente significativo", sub: "Criterio cualitativo del SEC.", cols: ["influye en la oferta y en la demanda"] },
            { nom: "Regla del 50 %", sub: "Prueba cuantitativa, con exigencia de continuidad.", cols: ["ventas ÷ costes de producción ≥ 50 % varios años"] },
