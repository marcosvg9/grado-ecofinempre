      ...
      contenido: [
        {
          ...
          filas: [
            ...
            { nom: "Incidencia económica", sub: "Soporta la carga quien menos puede escapar.", cols: ["carga sobre demanda ÷ carga sobre oferta = εₛ ÷ εd"] },
            { nom: "Cuña fiscal", sub: "La distancia entre coste y salario neto.", cols: ["(coste empresarial − salario neto) ÷ coste empresarial"] },
            { nom: "Tipo marginal", sub: "Gobierna los incentivos.", cols: ["impuesto sobre el último euro"] },
            { nom: "Tipo medio efectivo", sub: "Gobierna la carga real.", cols: ["cuota ÷ base"] },
            { nom: "Progresividad", sub: "El tipo medio crece con la base.", cols: ["d(tipo medio) ÷ d(base) > 0"] },
            { nom: "IVA sobre renta", sub: "Regresivo sobre renta anual.", cols: ["cuota ÷ renta decrece al subir la renta"] },
            { nom: "IVA sobre consumo", sub: "Proporcional dentro de cada tipo.", cols: ["cuota ÷ consumo constante"] },
            { nom: "Presión fiscal", sub: "Mide ingresos, no esfuerzo ni tipos.", cols: ["Ingresos públicos ÷ PIB"] },
            { nom: "Esfuerzo fiscal", sub: "Corrige por el nivel de renta del país.", cols: ["presión fiscal ÷ PIB per cápita relativo"] },
          ],
        },
      ],
    },
