      ...
      contenido: [
        {
          ...
          filas: [
            ...
            { nom: "Condición de Samuelson", sub: "Se suman las disposiciones a pagar.", cols: ["$\\sum_i \\mathrm{RMS}_i = \\mathrm{CMg}$"] },
            { nom: "Problema del polizón", sub: "Por eso no se financian voluntariamente.", cols: ["nadie revela su valoración real"] },
            { nom: "Exceso de gravamen", sub: "Riqueza que no se genera; no la recauda nadie.", cols: ["$\\mathrm{EG} \\approx \\tfrac12 t^2 \\dfrac{\\eta\\,\\varepsilon}{\\eta + \\varepsilon}\\,pq$"] },
            { nom: "Propiedad cuadrática", sub: "La regla más robusta del diseño fiscal.", cols: ["duplicar $t \\Rightarrow$ cuadruplicar EG"] },
            { nom: "Coste marginal de los fondos", sub: "Un euro público cuesta más de un euro.", cols: ["CMF = 1 + dEG/dR > 1"] },
            { nom: "Regla de Ramsey", sub: "Eficiente y regresiva a la vez.", cols: ["$t_i \\propto \\dfrac{1}{\\varepsilon_i}$"] },
