      ...
      contenido: [
        {
          ...
          filas: [
            ...
            { nom: "Solución del trilema", sub: "Se sacrifica la movilidad de capitales.", cols: ["tipo fijo + política monetaria propia ⟹ control de capitales"] },
            ...
            { nom: "Cobertura de la promesa", sub: "Se degrada sola si los dólares crecen.", cols: ["oro ÷ dólares en manos extranjeras ↓"] },
            ...
            { nom: "Aritmética del alcance", sub: "Cuánto tarda un país en acercarse.", cols: ["ratio_t = ratio_0 · [(1+g) ÷ (1+g*)]^t"] },
          ],
        },
      ],
    },
