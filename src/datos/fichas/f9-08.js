      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Elasticidad precio de la demanda", sub: "Negativa en condiciones normales.", cols: ["$\\varepsilon = \\dfrac{\\%\\,\\Delta \\text{cantidad}}{\\%\\,\\Delta \\text{precio}}$"] },
            { nom: "Margen relativo óptimo", sub: "Regla de Lerner con coste marginal constante.", cols: ["$\\dfrac{P - \\mathrm{CMg}}{P} = \\dfrac{1}{|\\varepsilon|}$"] },
            { nom: "Volumen necesario tras bajar el precio", sub: "Para mantener el margen total.", cols: ["$\\Delta q$ necesario $= \\dfrac{m_0}{m_1} - 1$"] },
            { nom: "Margen unitario", sub: "El punto de partida de cualquier decisión de precio.", cols: ["m = P − Coste variable unitario"] },
            { nom: "Apalancamiento del precio", sub: "Un punto de precio vale más que uno de volumen.", cols: ["$\\dfrac{\\Delta\\text{Beneficio}}{\\text{Beneficio}} = \\dfrac{\\Delta P \\cdot Q}{m \\cdot Q}$"] },
            { nom: "Precio basado en valor", sub: "El techo lo marca la alternativa del cliente.", cols: ["$P \\leq$ Precio de la alternativa $+$ Valor diferencial percibido"] },
          ],
        },
      ],
    },
