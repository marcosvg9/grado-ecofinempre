      ...
      contenido: [
        {
          ...
          modo: "dos",
          filas: [
            { nom: "Base imponible", sub: "Punto de partida contable, ajustes extracontables después.", cols: ["$\\mathrm{BI} = \\mathrm{RCAI} \\pm \\text{permanentes} \\pm \\text{temporarias} - \\text{BINs compensadas}$"] },
            ...
            { nom: "Gasto por impuesto", sub: "Lo que aparece en la cuenta de resultados.", cols: ["Gasto $= \\mathrm{IC} + \\Delta\\text{Pasivos diferidos} - \\Delta\\text{Activos diferidos}$"] },
            { nom: "Comprobación", sub: "Solo las diferencias permanentes separan una cifra de la otra.", cols: ["Gasto $= (\\mathrm{RCAI} \\pm \\text{permanentes}) \\times \\text{tipo}$"] },
          ],
          ...
          items: [
            {
              ...
              correcta: 1,
              porque: [
                "La diferencia se registra como activo o pasivo por impuesto diferido, no contra reservas.",
                "El gasto refleja el impuesto que corresponde al resultado contable del ejercicio; la cuota refleja lo que la norma fiscal exige pagar este año. La diferencia son los diferidos.",
                "Las bases negativas son una de las causas de divergencia, no la única ni la que define la distinción.",
                "Confundirlos es lo que hace incomprensible la cuenta de resultados de cualquier empresa con diferencias temporarias.",
              ],
            },
            {
              ...
              correcta: 3,
              porque: [
                "Es el error con más consecuencias del capítulo: tratar como permanente algo que revertirá deja de reconocer un activo real.",
                "El carácter de la diferencia se determina al nacer, según si revertirá o no.",
                "Sí hay diferencia: el resultado contable y la base imponible difieren este año, y esa es la definición.",
                "La clave es si la diferencia desaparece con el tiempo. Como el gasto acabará siendo deducible, hoy se ha pagado un impuesto que se recuperará, y eso es un activo.",
              ],
            },
            {
              ...
              correcta: 2,
              porque: [
                "El tipo actual sirve para la cuota del ejercicio, no para valorar impuestos que se liquidarán en el futuro.",
                "Promediar no corresponde a ninguna previsión concreta de reversión.",
                "Los diferidos se valoran al tipo que se espera aplicable cuando reviertan, y una reforma ya aprobada obliga a reexpresarlos con efecto inmediato en el resultado.",
                "La prudencia no es un criterio para elegir tipos: la norma dice cuál se usa.",
              ],
            },
            {
              ...
              correcta: 3,
              porque: [
                "No hace falta autorización: es una decisión contable que la auditoría revisa.",
                "La antigüedad afecta a la compensación fiscal, no al reconocimiento contable del activo.",
                "El derecho legal existe, pero activar un crédito exige además que sea recuperable: si nunca habrá beneficios que compensar, el activo no vale nada.",
                "Sin ese soporte, activar bases negativas infla el activo justo en el momento en que la empresa está peor, que es cuando más engaña.",
              ],
            },
          ],
